...
namespace Geometry
{
    ...
    public class Cube
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("X1" + _X1.ToString());
            sb.Append("X2" + _X2.ToString());
            sb.Append("Y1" + _Y1.ToString());
            sb.Append("Y2" + _Y2.ToString());
            sb.Append("Z1" + _Z1.ToString());
            sb.Append("Z2" + _Z2.ToString());
